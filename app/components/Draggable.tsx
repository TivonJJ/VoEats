...
const Draggable = React.forwardRef<DraggableRef, DraggableProps>(function Draggable(props, ref) {
    ...
    React.useImperativeHandle(
        ...
        () => {
            return {
                pan: pan.current,
                setPosition: (x, y) => {
                    return pan.current.setValue({ x, y });
                },
                getBounds,
            };
        },
    ...
    const dragItemCss = React.useMemo<StyleProp<ViewStyle>>(() => {
        return {
            top: y,
            left: x,
            elevation: z,
